...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="featherweight" Type="Folder">
			<Item Name="Core" Type="Folder">
				...
				<Item Name="Application" Type="Folder">
					<Item Name="FTW-App-StringToVersion.vi" Type="VI" URL="../featherweight/Core/Application/FTW-App-StringToVersion.vi"/>
				...
				<Item Name="Numeric" Type="Folder">
					...
					<Item Name="FTW-NUM-EnumItems.vi" Type="VI" URL="../featherweight/Core/Numeric/FTW-NUM-EnumItems.vi"/>
				...
				<Item Name="String" Type="Folder">
					...
					<Item Name="FTW-STR-Display-Bytes.vi" Type="VI" URL="../featherweight/Core/String/FTW-STR-Display-Bytes.vi"/>
					<Item Name="FTW-STR-DisplayFormat-Bytes.ctl" Type="VI" URL="../featherweight/Core/String/FTW-STR-DisplayFormat-Bytes.ctl"/>
					<Item Name="FTW-STR-Encode-Hex.vi" Type="VI" URL="../../Reuse Library/featherweight/Core/String/FTW-STR-Encode-Hex.vi"/>
					<Item Name="FTW-STR-Indent.vi" Type="VI" URL="../featherweight/Core/String/FTW-STR-Indent.vi"/>
					...
					<Item Name="FTW-STR-ReplaceAll.vi" Type="VI" URL="../featherweight/Core/String/FTW-STR-ReplaceAll.vi"/>
				...
				<Item Name="Time" Type="Folder">
					<Item Name="FTW-Time-Display-Elapsed.vi" Type="VI" URL="../featherweight/Core/Time/FTW-Time-Display-Elapsed.vi"/>
					<Item Name="FTW-Time-Display-Timestamp.vi" Type="VI" URL="../../Reuse Library/featherweight/Core/Time/FTW-Time-Display-Timestamp.vi"/>
					<Item Name="FTW-Time-DisplayFormat-Elapsed.ctl" Type="VI" URL="../featherweight/Core/Time/FTW-Time-DisplayFormat-Elapsed.ctl"/>
			...
			<Item Name="Dev" Type="Folder">
				<Item Name="Project" Type="Folder">
					...
					<Item Name="FTW-Project-DiscoverBuildSpecs.vi" Type="VI" URL="../featherweight/Dev/Project/FTW-Project-DiscoverBuildSpecs.vi"/>
					<Item Name="FTW-Project-Filepath.vi" Type="VI" URL="../../Reuse Library/featherweight/Dev/Project/FTW-Project-Filepath.vi"/>
					<Item Name="FTW-ProjectItem-GetItemInfo.vi" Type="VI" URL="../featherweight/Dev/Project/FTW-ProjectItem-GetItemInfo.vi"/>
					<Item Name="FTW-ProjectItem-IDtoRef.vi" Type="VI" URL="../featherweight/Dev/Project/FTW-ProjectItem-IDtoRef.vi"/>
				...
				<Item Name="Resource Proxy" Type="Folder">
					<Item Name="WirebirdLabs-ResourceProxy-ItemID.ctl" Type="VI" URL="../featherweight/Dev/Resource Proxy/WirebirdLabs-ResourceProxy-ItemID.ctl"/>
				</Item>
			</Item>
			<Item Name="Security" Type="Folder">
				<Item Name="Encryption" Type="Folder">
					<Item Name="FTW-Crypto-PublicKeySignature-Sign.vi" Type="VI" URL="../featherweight/Security/Encryption/FTW-Crypto-PublicKeySignature-Sign.vi"/>
					<Item Name="FTW-Crypto-PublicKeySignature-Verify.vi" Type="VI" URL="../featherweight/Security/Encryption/FTW-Crypto-PublicKeySignature-Verify.vi"/>
					<Item Name="FTW-Crypto-String-Sign.vi" Type="VI" URL="../featherweight/Security/Encryption/FTW-Crypto-String-Sign.vi"/>
					<Item Name="FTW-Crypto-String-Verify.vi" Type="VI" URL="../featherweight/Security/Encryption/FTW-Crypto-String-Verify.vi"/>
				</Item>
			</Item>
			<Item Name="UI" Type="Folder">
				<Item Name="FileSystem" Type="Folder">
					<Item Name="FTW-FileSystem-CommandLineExecute.vi" Type="VI" URL="../featherweight/UI/FileSystem/FTW-FileSystem-CommandLineExecute.vi"/>
					<Item Name="FTW-FileSystem-OpenDirectoryOrParent.vi" Type="VI" URL="../featherweight/UI/FileSystem/FTW-FileSystem-OpenDirectoryOrParent.vi"/>
					<Item Name="FTW-FileSystem-PathToURI.vi" Type="VI" URL="../featherweight/UI/FileSystem/FTW-FileSystem-PathToURI.vi"/>
				</Item>
			...
			<Item Name="Web" Type="Folder">
				...
				<Item Name="Utils" Type="Folder">
					<Item Name="FTW-Web-EscapeURL.vi" Type="VI" URL="../featherweight/Web/Utils/FTW-Web-EscapeURL.vi"/>
				</Item>
			</Item>
		</Item>
		...
		<Item Name="UDL Connection" Type="Folder">
			<Item Name="SheetMeasureDB.udl" Type="Document" URL="../../../Users/tommyj.ITS/Documents/SheetMeasureDB.udl"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Deploy-ConfigDialog-Menu.rtm" Type="Document" URL="../Support/Configuration Dialog/Deploy-ConfigDialog-Menu.rtm"/>
			...
			<Item Name="FTW-File-ValidateFilepath.vi" Type="VI" URL="../../Reuse Library/featherweight/Core/File/FTW-File-ValidateFilepath.vi"/>
			...
			<Item Name="FTW-Regex-FilterArray.vi" Type="VI" URL="../../Reuse Library/featherweight/Core/Regex/FTW-Regex-FilterArray.vi"/>
